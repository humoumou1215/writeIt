...
| customerId      | bigint | 20 | 否       | <br />  | [[数据库/customer/customer_info#id]]        | 客户ID                         |
...
| applyDate       | date   | 10 | 否       | <br />  | [[数据库/loan/loan_apply#apply_date]]       | 申请日期                         |
| status          | int    | 16 | 是       | 业务状态    | [[数据库/loan/loan_apply#status]]           | 交易状态：PROCESSING/SUCCESS/FAIL |
